...
namespace Picalines.Godot.LDtkImport.Importers
{
    ...
    public class LevelImport : SceneImport<Node2D, LevelImportContext, LevelImportExtension>
    {
        ...
        {
            var tileMapImporter = new Lazy<TileMapLayerImporter>(() => new(ImportContext, SceneContext));

            var entityLayerImporter = new Lazy<EntityLayerImporter>(() => new(SceneContext, UsedExtension));
